"""Regression checks for the elixircircuit casebook."""
...
from casebook.harness import assert_expected, elixircircuit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(elixircircuit_summary(), assert_expected())
